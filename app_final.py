...
with tabs[0]:
    ...
    **SIPANDA-OCR** adalah dashboard automasi dokumen perpajakan yang dirancang untuk menyederhanakan proses pengolahan arsip secara cepat, akurat, dan terstandar. 
    ...
    st.markdown("""Gunakan panduan ini sebagai acuan dalam pengelolaan arsip dokumen perpajakan secara digital,
    mulai dari unggah, pemrosesan, hingga penyimpanan akhir.""")
    st.image("assets/1.png")
    st.markdown(
        """
    <a href="https://raw.githubusercontent.com/ranydwi/SIPANDA-OCR/main/assets/Panduan_SIPANDA_OCR.pdf" target="_blank"
    style="
